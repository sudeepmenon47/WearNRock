<?php
    ...
    \Stripe\Stripe::setApiKey(STRIPE_PRIVET);

    // Get the credit card details submitted by the form
    $token = $_POST['stripeToken'];
    //Get the rest the post data
...
?>
    ...
    <p>Your cart has been successfully charged <?=money($grand_total);?>. You have been emailed a recipt. please
        check your spam folder if it is not in your inbox. Additionally you can print this page as a reciept.</p>
